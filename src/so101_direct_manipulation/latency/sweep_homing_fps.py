...
Usage:
    python -m so101_direct_manipulation.latency.sweep_homing_fps
"""
...
from so101_direct_manipulation.shared.homing import (
    GRIPPER_OPEN,
    JOINT_ACTION_HOME,
    SAFE_HEIGHT,
    get_joint_positions,
)
from so101_direct_manipulation.shared.setup import ROBOT_ID, ROBOT_PORT
...
def main() -> int:
    ...
    print("\nGenerating plots...")
    path_output_dir = Path("outputs/sweep_homing_fps")
