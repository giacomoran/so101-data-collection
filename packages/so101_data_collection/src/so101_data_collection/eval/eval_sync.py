#!/usr/bin/env python
"""Synchronous ACT Relative RTC policy evaluation on SO101 robot.
...
Usage:
    python -m so101_data_collection.eval.eval_sync \
...
def run_episode_sync(
    ...
    while True:
        ...
        for action_idx in range(n_action_steps):
            ...
            action_tensor = action_chunk[:, action_idx, :]  # [batch, action_dim]
            ...
            # Ensures the queue advances with each action step, matching select_action behavior
